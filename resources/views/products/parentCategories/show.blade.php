...
@section('content')
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          @if($categoryParent->id == 1)
            <li class="breadcrumb-item"><a href="#">Gotovi proizvodi</a></li>
          @elseif($categoryParent->id == 2)
            <li class="breadcrumb-item"><a href="#">Poluproizvodi</a></li>
          @else
            <li class="breadcrumb-item">Sirovine</li>
          @endif
            <li class="breadcrumb-item active">Svi proizvodi</li>
        </ol>
      </nav>
    </h5>
    ...
    <br>  
  <div class="card">
{{--     <div class="card-header text-white text-center bg-dark">{{ $categoryParent->ime }}</div>
 --}}    <div class="card-body">
    	<table class="table">
              <thead>
                <tr>
